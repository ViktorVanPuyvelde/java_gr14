...
public class NieuweDatasourcePaneelController2 extends GridPane
{
	...
	//TreeMap<Double, List<tempMvoData>> verwerkteData;

	private MvoDataController mdc;
	Mvo mvo;

	public NieuweDatasourcePaneelController2(Datasource d, DatasourceController controller)
	{
	...
	public NieuweDatasourcePaneelController2() {
