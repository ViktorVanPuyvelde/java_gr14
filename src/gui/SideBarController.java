...
public class SideBarController extends BorderPane
{
	...
	/*
	 * @FXML private void HPMvo(MouseEvent event) { toMvo(); }
	 */
	...
	/*
	 * @FXML private void HPCat(MouseEvent event) { toCategorie(); }
	 */
	...
	/*
	 * @FXML private void HPData(MouseEvent event) { toDatasource(); }
	 */
